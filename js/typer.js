var Typer = function(element) {
   ...
   Typer.prototype.doTyping = function() {
     ...
     if (p.building && atWordEnd && this.loop !== "true") {
       // type-once mode: finish typing the last word, then hold (cursor keeps blinking)
       this.typing = false;
     }
   ...
   function TyperSetup() {
     ...
     window.__typers = typers; // expose instances so the page can restart them
